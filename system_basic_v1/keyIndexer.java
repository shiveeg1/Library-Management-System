...
public class keyIndexer {
  ...
  public static void main(String[] args) {
	  ...
	  System.out.println("after return"+sortedMap(hmap));
  }
 public static HashMap calc(KBean bean) throws IOException {
	   ...
	   return sortedMap(hmap);
 }
 public static HashMap sortedMap(HashMap map){
	 ...
	 HashMap smap = new LinkedHashMap ();
		for(Iterator it = list.iterator(); it.hasNext();){
			...
			smap.put(ent.getKey(), ent.getValue());
		}
		return smap;
